...
{
    public partial class frmStorageBins : Form
    {
        ...
        public frmStorageBins(frmStarter parent)
        {
            InitializeComponent();
            this.Owner = parent;
        ...
        {
            frmStorageBin FrmItem = new frmStorageBin(this);
            FrmItem.Show();
        }
