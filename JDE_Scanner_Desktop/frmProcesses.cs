    ...
    public partial class frmProcesses : Form
    {
        ...
        private async void Reload()
        {
            ...
            if (TypeId != null)
            {
                ...
                {
                    List<string> Columns = new List<string>() { "ProcessId", "Comment", "Status", "PlannedStart", "PlannedFinish", "PlaceId", "PlaceName", "AssignedUserNames", "StartedOn", "StartedByName", "FinishedOn", "FinishedByName", "Length","Output","AbandonReasonNames", "GivenTime", "TimingStatus", "FinishRate", "TimingVsPlan", "HandlingsLength", "ProcessLength" };
