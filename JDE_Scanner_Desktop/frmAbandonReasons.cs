...
{
    public partial class frmAbandonReasons : Form
    {
        AbandonReasonKeeper Keeper = new AbandonReasonKeeper();
        frmLooper looper;
        int page;
        frmFilter FrmFilter;
        ...
        public frmAbandonReasons(Form parent)
        {
            InitializeComponent();
            this.Owner = parent;
        ...
        {
            frmAbandonReason Form = new frmAbandonReason(this);
            Form.Show();
        }
